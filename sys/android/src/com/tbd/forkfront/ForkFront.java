...
public class ForkFront extends Activity
{
	...
	private final int REQUEST_ALL_FILES_ACCESS = 44;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		// Title bar visibility is now handled by the theme in AndroidManifest.xml
		...
		else if(requestCode == REQUEST_ALL_FILES_ACCESS)
		{
			if(mRequestExternalStorageResult != null)
			{
				if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R && Environment.isExternalStorageManager())
					...
					mRequestExternalStorageResult.onDenied();
				mRequestExternalStorageResult = null;
			}
		}
