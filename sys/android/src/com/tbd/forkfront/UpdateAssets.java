...
public class UpdateAssets extends AsyncTask<Void, Void, Void>
{
	...
	private void updateFiles(File dstPath) throws IOException
	{
		...
		if (files == null || files.length == 0)
			throw new IOException("No assets found in " + mNativeDataDir);
...
//		return null;
	...
	{
		// We rename the intent of this method: Internal is safer than External.
		// getFilesDir() points to: /data/user/0/com.gurrhack.unnethack/files
		File dataDir = mActivity.getFilesDir();
		File finalPath = new File(dataDir, "unnethack_data");
